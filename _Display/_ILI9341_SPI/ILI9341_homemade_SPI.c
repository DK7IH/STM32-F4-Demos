...
//SPI ARM Corex-M4 MCU using "homemade" SPI
//functions to drive an IL9341 serial LCD. 
...
//Display buffer
char *oldbuf = (char*)"         ";
int bgcolor = DARKBLUE; //Standard Background Color
...
int main(void)
{
    ...
    lcd_putstring(0, 0 * FONTHEIGHT, (char*)"ABCDEFGHIJK", 1, LIGHTRED, bgcolor);    
    lcd_putstring(0, 1 * FONTHEIGHT, (char*)"LMNOPQRSTUV", 1, LIGHTGREEN, bgcolor);    
    lcd_putstring(0, 2 * FONTHEIGHT, (char*)"XYZ!%&/()=?", 1, LIGHTBLUE, bgcolor);    
    lcd_putstring(0, 3 * FONTHEIGHT, (char*)"1234567890", 2, LIGHTBLUE, bgcolor);    
    lcd_putstring(0, 5 * FONTHEIGHT, (char*)",;.:-_#*+-", 2, YELLOW, bgcolor);    
